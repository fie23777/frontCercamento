...
<nav class="navbar navbar-inverse">
  <div class="container">
	...
	<section class="container">
		 ...
		 <form:form id="form-adiciona" action="${s:mvcUrl('EC#listarResult').build() }" method="post">
		 
	            <h2>Lista de todos os resultados da lotofácil</h2>
						   ...
						   <c:forEach items="${resultados }" var="resultado">
									 <tr class="resultados" id="resultados" >
							            ...
							            <td class="info-concurso">${resultado.nunConcurso }</td>
							             <td class="info-concurso">${resultado.esquema }</td>
									</tr>
					      </c:forEach> 
					</tbody>
				</table>
